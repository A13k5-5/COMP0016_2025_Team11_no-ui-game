...
NODE_USER_MESSAGE: str = (
    ...
    "IS_WIN: {is_win}\n"
    "IS_LOSING: {is_losing}\n"
    "TEXT RULE: max 300 characters, end with a complete sentence and final punctuation.\n\n"
